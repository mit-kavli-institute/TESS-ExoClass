...
#                                gtTOI, gtDisp, gtPer, gtEpc, gtDur)
    ...
    allra = np.array(all_tces['raDeg'])
    alldec = np.array(all_tces['decDeg'])
    allrow = np.array(all_tces['row'])
    allcol = np.array(all_tces['col'])
    allcam = np.array(all_tces['camera'])
    allccd = np.array(all_tces['ccd'])
    allpixvalid = np.array(all_tces['pixposvalid'])
